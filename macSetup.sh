...
brew install git hub watchman tree \
delta switchaudio-osx

# ADD HERE REACT NATIVE RELATED PACKAGES
...
semantic-release-cli npm-check-updates firebase

echo "installing apps with brew cask"
brew install --cask alfred google-chrome firefox brave-browser bettertouchtool divvy \
bartender google-drive itsycal visual-studio-code 1password \
skype discord obs sip \
